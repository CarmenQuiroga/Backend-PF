...
import com.backend.portf.DTO.dtoExperiencia;
import com.backend.portf.Entity.Experiencia;
import com.backend.portf.Security.Controller.Mensaje;
import com.backend.portf.Service.SExperiencia;
...
public class CExperiencia {
    ...
    public ResponseEntity<?> create(@RequestBody dtoExperiencia dtoexp){
        ...
        Experiencia experiencia = new Experiencia(dtoexp.getNombreE(), dtoexp.getDescripcionE(), dtoexp.getFechaE(),dtoexp.getTareaE());
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoExperiencia dtoexp){
       ...
       if(sExperiencia.existsByNombreE(dtoexp.getNombreE()) && sExperiencia.getByNombreE(dtoexp.getNombreE()).get().getId() != id)
        ...
        experiencia.setTareaE(dtoexp.getTareaE());
